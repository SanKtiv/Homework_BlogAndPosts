...
blogRouter.post( '/blogs', validBlog, basicAuth, errorsOfValidate, async (req: Request, res: Response) => {
...
blogRouter.put('/blogs/:id', validBlog, basicAuth, validId, errorsOfValidate, async (req: Request, res: Response) => {
